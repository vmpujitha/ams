            ...
            <div className='rent-page-wrapper'>
                {
                    ...
                    <div className='item-cars' >
                        <p className='name'>{"car"}<span> {"Hyundai"}</span></p>
                        <div className='options'>
                            <p className='car-type'><span><MdDirectionsCar /></span> {"Hyundai"}</p>
                            <p className='car-type'><span><MdAirlineSeatReclineNormal /></span> {"6"}</p>
                            <p className='car-type'><span><GoGear /></span> {"7"}</p>
                            <p className='car-type'><span><IoMdSnow /></span> {selected.clima ? 'yes' : 'no'}</p>
                        </div>  
                                            
                        <p className='price'>Price - € 6000<span>{fixedPrice}</span> /For a Day </p>
                    </div>
